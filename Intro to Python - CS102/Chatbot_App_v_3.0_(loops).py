...
# Begin outer loop to allow repeating the chatbot session
while True:
    ...
    # Determining fare to Mars based on age using the flowchart
    if age < 12:
        fare = "$5000"
    ...
    print(f"Thanks for the chat, {name} from {hometown}! I'm glad to learn about you a little bit, and keep coding in {favorite_language}. "
    ...
    repeat = input().lower()
    if repeat != 'y':
        break  # Exiting the loop if the user does not want to continue
